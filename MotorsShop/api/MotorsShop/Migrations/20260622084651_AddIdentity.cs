    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Track-oriented", "Sport" },
                    { 2, "Long-distance comfort", "Cruiser" },
                    { 3, "On and off-road", "Adventure" }
                });

            migrationBuilder.InsertData(
                table: "Motorcycles",
                columns: new[] { "Id", "BrandId", "CategoryId", "Description", "EngineCc", "Name", "Price", "Stock", "Year" },
                values: new object[,]
                {
                    { 1, 1, 1, null, 599, "CBR600RR", 12000m, 5, 2024 },
                    { 2, 2, 1, null, 689, "MT-07", 8500m, 8, 2024 },
                    { 3, 3, 3, null, 1254, "R 1250 GS", 22000m, 3, 2024 }
                });
